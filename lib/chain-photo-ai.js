...
const { openAiVisionChatUrl, openAiVisionHeaders, visionModel } = require('./openai-compatible');
 ...
 * @param {string} [opts.referenceSnippet] - extra technical text
 * @param {object} opts.env
 * @param {object[]} opts.presets - from getCubanPresets() for id list
 */
